...
<main class="flex justify-center py-[50px] px-10">
    <div class="bg-white mb-[30px] p-5">
        <h2 class="my-[30px] text-[40px] font-bold text-center mx-auto border-[#662d91] border-b-4 w-1/6">Hóa Đơn</h2>
                                ...
                                <?php foreach ($bills as $b) : ?>
                                    <tr class="bg-white border-b">
                                        ...
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r">
                                            ...
                                            <?php else : ?>
                                                <div class="bg-yellow-500 px-5 py-2 capitalize text-white">Đang được xử lý</div>
                                            <?php endif; ?>
                                        </td>
