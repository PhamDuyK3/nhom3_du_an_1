...
<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
	<!--begin::Logo-->
	<a href="index.html">
		<img alt="Logo" style="width: 50px;height: 50px;" src="public/images/home/image 1.png" />
	</a>
	<!--end::Logo-->
	<!--begin::Toolbar-->
		...
		<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
			...
			<div class="brand flex-column-auto" id="kt_brand">
				...
				<a href="index.html" class="brand-logo">
					<img class="" style="width: 190px;height: 50px;" alt="Logo" src="public/images/home/image 1.png" />
				</a>
				<!--end::Logo-->
				<!--begin::Toggle-->
					...
					<div class="topbar">
						...
						<div class="topbar-item">
							<div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
								...
								<span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"><?php echo $user['hoten'] ?></span>
								<span class="symbol symbol-35 symbol-light-success">
									<span class="symbol-label font-size-h5 font-weight-bold"><?php echo substr($user['hoten'], 0, 1) ?></span>
								</span>
							</div>
						</div>
						<!--end::User-->
